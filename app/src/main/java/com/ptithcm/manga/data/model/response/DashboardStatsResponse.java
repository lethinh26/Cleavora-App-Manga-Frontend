...
public class DashboardStatsResponse {
    ...
    public void setTotalMangas(long totalMangas) {
    ...
    public long getTotalPendingMangas() {
        return totalPendingMangas;
    }

    public void setTotalPendingMangas(long totalPendingMangas) {
        this.totalPendingMangas = totalPendingMangas;
    }
}
